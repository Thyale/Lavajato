  ...
  return (
    <div className="DivValoresContainer">
        ...
        <div className="DivValoresContainerCards">
            ...
            <ValoresCard valor="R$ 189,90" nome="Pacote Premium Detail" descp="Para quem exige brilho e proteção em nível máximo." info1="Lavagem Premium ecológica (externa e interna)." info2="Higienização total com ozonização." info3="Polimento técnico." info4="Proteção de pintura com Nano Coat."/>
